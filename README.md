...
| MCP (alpha) | ✅ Read-only server — local context, GitHub, ClickUp, Airtable connectors shipped |
...
- Additional connectors (Linear, Jira, Notion) are planned one per version. See `docs/mcp-connector-roadmap.md`.
