#!/usr/bin/env node
// Preview-first local installer for the omp and omp-mcp command shims, plus the
// retained compatibility and deprecated aliases. Preview by default; writes only
