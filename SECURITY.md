...
| Release line | Status                                                           |
| ------------ | ---------------------------------------------------------------- |
| `v0.6.x`     | **Supported.** `v0.6.2` is the current published stable release. |
...
`v0.6.1` and `v0.6.0` remain published and immutable, but they are superseded
within their own line: the supported artifact is `v0.6.2`. Every release before
them, including the whole v0.5 line, stays published and immutable as well.
