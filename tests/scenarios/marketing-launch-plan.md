...
**Purpose:** Verify that Oh My PM reviews a marketing launch plan and identifies gaps.
...
- Key risks identified (designer bandwidth, screenshot dependency)
- Immediate actions with owners
- No unnecessary padding

## Pass criteria

- [ ] Designer bandwidth risk flagged
- [ ] Screenshot dependency risk flagged
