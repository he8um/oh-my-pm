...
| --- | --- | --- | --- |
| قرارداد API نهایی نشده | بالا | بالا | قبل از شروع مهندسی تعریف شود |
| تأخیر تأیید design | متوسط | بالا | تایم‌لاین تأیید امروز تأیید شود |
...
- API, frontend, backend, onboarding, design, rollback plan, production, sprint

این مطابق سیاست زبانی Oh My PM است.
